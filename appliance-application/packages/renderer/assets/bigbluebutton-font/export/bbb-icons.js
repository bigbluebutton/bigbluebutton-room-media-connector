...
function renderGlyph(name, index) {
  var glyphDiv =
    '<div class="glyph fs1"><div class="clearfix bshadow0 pbs"><span class="icon-icon-bbb-applause"></span><span class="mls"> icon-bbb-' +
    name +
    '</span></div>';
  glyphDiv +=
    '<fieldset class="fs0 size1of1 clearfix hidden-false"><input type="text" readonly value="' +
    index +
    '" class="unit size1of2" />';
  glyphDiv +=
    '<input type="text" maxlength="1" readonly value="&#x' +
    index +
    ';" class="unitRight size1of2 talign-right icon-bbb-' +
    name +
    '" />';
  glyphDiv += '</fieldset>';
